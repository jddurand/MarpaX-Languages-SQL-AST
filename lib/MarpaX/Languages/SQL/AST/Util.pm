...
package MarpaX::Languages::SQL::AST::Util;

# ABSTRACT: SQL Translation to AST - Class method utilities
...
sub traceAndUnpack {
    ...
    #
    # Skip MarpaX::Languages::SQL::AST::if any
    #
    $whowasi =~ s/^MarpaX::Languages::SQL::AST:://;
