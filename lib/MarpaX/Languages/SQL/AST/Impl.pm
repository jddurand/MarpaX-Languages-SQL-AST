...
package MarpaX::Languages::SQL::AST::Impl;

# ABSTRACT: Implementation of Marpa's interface

use Marpa::R2;
use Carp qw/croak/;
use MarpaX::Languages::SQL::AST::Impl::Logger;
...
sub BEGIN {
    ...
    if (! defined($MARPA_TRACE_FILE_HANDLE)) {
      ...
      if (! tie ${$MARPA_TRACE_FILE_HANDLE}, 'MarpaX::Languages::SQL::AST::Impl::Logger') {
...
=head1 SYNOPSIS
    ...
    use strict;
    use warnings FATAL => 'all';
    use MarpaX::Languages::SQL::AST::Impl;

    my $marpaImpl = MarpaX::Languages::SQL::AST::Impl->new();
